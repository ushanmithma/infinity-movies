...
<head>
	...
	<title>Update - <?php if (isset($id)) { echo $get_name; } ?></title>
</head>
<body>
	...
	<div class="go-back"><a href="view.php?id=<?php if (isset($id)) { echo $id; } ?>">« Go Back</a></div>
	<div class="container">
		<form action="update.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<label>Age Rating: </label>
					...
					<input type="radio" name="age-rating" id="age-rating" value="R" <?php if (isset($id)) { if ($get_age_rating == "R") { echo 'checked'; } } ?>> R
