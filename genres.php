...
<head>
	...
	<title>Genres - Infinity Movies</title>
</head>
<body>
	...
	<section class="landing">
		...
		<div class="action-mov" id="action-mov">
			<div class="sec-name">
				<h1>Popular Action Movies</h1>
				<a href="#">View All</a>
			</div>
			<div class="mov-list">
				<?php

					$get_latest_mov = "SELECT id, name, imdb_rating, release_date FROM movies WHERE genres LIKE '%Action%' ORDER BY box_office DESC, release_date DESC, name LIMIT 6";
		...
		<div class="fantasy-mov" id="fantasy-mov">
			<div class="sec-name">
				<h1>Popular Fantasy Movies</h1>
				<a href="#">View All</a>
			</div>
			<div class="mov-list">
				<?php

					$get_latest_mov = "SELECT id, name, imdb_rating, release_date FROM movies WHERE genres LIKE '%Fantasy%' ORDER BY box_office DESC, release_date DESC, name LIMIT 6";
		...
		<div class="crime-mov" id="crime-mov">
			<div class="sec-name">
				<h1>Popular Crime Movies</h1>
				<a href="#">View All</a>
			</div>
			<div class="mov-list">
				<?php

					$get_latest_mov = "SELECT id, name, imdb_rating, release_date FROM movies WHERE genres LIKE '%Crime%' ORDER BY box_office DESC, release_date DESC, name LIMIT 6";
